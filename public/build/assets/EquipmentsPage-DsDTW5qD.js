import{r as v,u as R,j as e,a as k,R as O}from"./app-R59AgTg3.js";import{B as m}from"./button-DUunvkwS.js";import{A as B}from"./app-sidebar-CocvIPWR.js";import{S as $,a as z,b as F,c as D}from"./avatar-B6LBOXhP.js";import{S as V}from"./sweetalert2.esm.all-BQIkj5Wb.js";import{I as _}from"./input-Cjcb1XXh.js";import{N as M}from"./Notification-CF-jvzA4.js";import{T as L,a as U,b as P,c as f,d as H,e as b}from"./table-DjXEBKHJ.js";import{B as Q,a as G,b as K,c as q,d as W}from"./breadcrumb-CywDlYat.js";import{P as X,a as Y,b as J}from"./popover-oWTaW9Cl.js";import{S as y,a as w,b as C,c as S,d as p}from"./select-H4pFk2ME.js";import{P as Z}from"./printer-Dcb-M0U0.js";import{E as ee}from"./eye-BuMQwTsy.js";import{P as te}from"./pen-DTqWI1Jt.js";import{X as se}from"./index-CPvmv8yZ.js";import"./index-DurLkVUy.js";import"./utils-CBfrqCZ4.js";import"./dropdown-menu-DEfTj1Cp.js";import"./createLucideIcon-BRqj4ZpW.js";import"./index-Cpb0aSub.js";import"./index-B4D52uEu.js";import"./index-DulClGaF.js";import"./index-kdZ0iaiW.js";import"./chevron-right-DiwCHu_D.js";import"./sparkles-CYWeqXNt.js";import"./bell-D4LjbV-4.js";import"./keyboard-CNVVLoqW.js";import"./boxes-CWfJ03mT.js";import"./users-CweJ4Eq4.js";import"./user-bNgG0aCA.js";import"./chevron-down-CdK_YvPQ.js";import"./index-0a4pAYos.js";import"./index-WPOC8fpL.js";import"./index-CK0qY2tO.js";function le({filters:o,filterOptions:h,onApplyFilters:x}){const[i,j]=v.useState(""),[n,a]=v.useState(""),u=s=>{const d=s==="all"?"":s;a(d),i==="type"?x({...o,type:d}):i==="condition"?x({...o,condition:d}):i==="room"&&x({...o,room_id:d})},g=()=>{j(""),a(""),x({type:"",condition:"",room_id:""})};return e.jsxs(X,{children:[e.jsx(Y,{asChild:!0,children:e.jsx(m,{size:"sm",className:"flex items-center gap-2 bg-[hsl(142,34%,51%)] text-white border-none hover:bg-[hsl(142,34%,45%)]",children:"Filters"})}),e.jsx(J,{className:"w-72",children:e.jsxs("div",{className:"flex flex-col gap-3",children:[e.jsxs(y,{value:i,onValueChange:s=>{j(s),a("")},children:[e.jsx(w,{children:e.jsx(C,{placeholder:"Select filter field"})}),e.jsxs(S,{children:[e.jsx(p,{value:"type",children:"Type"}),e.jsx(p,{value:"condition",children:"Condition"}),e.jsx(p,{value:"room",children:"Room"})]})]}),i==="type"&&e.jsxs(y,{value:n||"all",onValueChange:u,children:[e.jsx(w,{children:e.jsx(C,{placeholder:"Select Type"})}),e.jsxs(S,{children:[e.jsx(p,{value:"all",children:"All"}),h.types.map(s=>e.jsx(p,{value:s,children:s},s))]})]}),i==="condition"&&e.jsxs(y,{value:n||"all",onValueChange:u,children:[e.jsx(w,{children:e.jsx(C,{placeholder:"Select Condition"})}),e.jsxs(S,{children:[e.jsx(p,{value:"all",children:"All"}),h.conditions.map(s=>e.jsx(p,{value:s,children:s},s))]})]}),i==="room"&&e.jsxs(y,{value:n||"all",onValueChange:u,children:[e.jsx(w,{children:e.jsx(C,{placeholder:"Select Room"})}),e.jsxs(S,{children:[e.jsx(p,{value:"all",children:"All"}),Object.entries(h.rooms).map(([s,d])=>e.jsxs(p,{value:s,children:["Room ",d]},s))]})]}),(i||n)&&e.jsx("div",{className:"flex justify-end",children:e.jsxs(m,{size:"sm",variant:"outline",onClick:g,className:"flex items-center gap-1 text-red-600 hover:bg-red-50",children:[e.jsx(se,{className:"w-4 h-4"}),"Reset"]})})]})})]})}const ne=[{label:"Functional",color:"bg-green-500"},{label:"Defective",color:"bg-red-500"},{label:"Intermittent Issue",color:"bg-yellow-500"},{label:"Needs Cleaning",color:"bg-blue-500"},{label:"For Replacement",color:"bg-orange-500"},{label:"For Disposal",color:"bg-gray-500"},{label:"Condemn",color:"bg-black"}];function De({equipments:o,existingRooms:h,filters:x={}}){const[i,j]=v.useState(""),[n,a]=v.useState(1),[u,g]=v.useState(null),s=10;R();const d=t=>ne.find(r=>r.label.toLowerCase()===t.toLowerCase())||{label:t,color:"bg-gray-400"},E=v.useMemo(()=>{const t=r=>[...new Set(r.filter(Boolean))].sort();return{types:t(o.map(r=>r.type)),conditions:t(o.map(r=>r.condition)),rooms:Object.fromEntries(h.map(r=>[String(r.id),r.room_number]))}},[o,h]);function l(t){const r=Object.fromEntries(Object.entries({...t,search:i||void 0}).filter(([,c])=>c!==""&&c!==void 0));k.get("/equipments",r,{preserveState:!0,replace:!0})}const N=Math.ceil(o.length/s)||1,T=o.slice((n-1)*s,n*s),I=()=>{if(!o||o.length===0){alert("No equipment data available to print.");return}const t=window.open("","","width=900,height=700"),r=o.map((c,A)=>`
                <tr>
                    <td>${A+1}</td>
