...
class UnitsSeeder extends Seeder
{
    ...
    {
        // Get all rooms (201, 202, 203, 204)
        $rooms = DB::table('rooms')->whereIn('room_number', ['102', '103','201', '202', '203', '204'])->get();
        ...
        foreach ($rooms as $room) {
            for ($i = 1; $i <= 15; $i++) {
                ...
                $units[] = [
                    'unit_code'   => $unitCode,
                    'unit_path'   => 'isu-ilagan/ict-department/room-' . $room->room_number . '/' . strtolower($unitCode),
