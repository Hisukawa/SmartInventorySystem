import { Monitor, Mouse, Package, LogOut, LayoutDashboard } from "lucide-react";
...
export default function TechicianRoomSidebar({ room, user, active, onSelect }) {
    const links = [
        { key: "dashboard", label: "Dashboard", icon: LayoutDashboard },
        { key: "system-units", label: "Computers", icon: Monitor },
    ...
    return (
        <div
            className="w-64 flex flex-col justify-between h-full shadow-md text-white"
