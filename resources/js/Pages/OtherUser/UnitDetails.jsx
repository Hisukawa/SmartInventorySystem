        ...
        <Card className="w-full shadow-lg rounded-2xl border border-gray-200 overflow-hidden">
          ...
          <CardContent className="p-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <DetailItem icon={Building} label="Room" value={unit.room?.room_number ?? "N/A"} />
              <DetailItem icon={Cpu} label="Processor" value={unit.processor} />
              <DetailItem icon={MemoryStick} label="RAM" value={unit.ram} />
              <DetailItem icon={HardDrive} label="Storage" value={unit.storage} />
              <DetailItem icon={Monitor} label="GPU" value={unit.gpu ?? "N/A"} />
