...
// ✅ Lucide Icons
import { Building2, FileText, Eye } from "lucide-react"; // Added Eye icon
...
export default function FacultyDashboard({
  ...
  const filteredReports = useMemo(() => {
    ...
    // Assuming reports have a 'status' field. If not, you might need to infer it
    // or add it to your report data structure. For demonstration, let's assume 'status' exists.
    // Example statuses: 'pending', 'resolved', 'critical'
  ...
  return (
    <SidebarProvider>
      ...
      <SidebarInset>
        ...
        {/* Main Content */}
        <main className="w-full px-6 py-6 bg-gray-50 min-h-screen">
          {/* Two-Column Layout */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <section className="max-w-md w-full">
              <Card className="p-4">
                ...
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h2
                    className="font-bold text-sm px-3 py-1 rounded-md bg-green-600 border border-green-700 text-white inline-block"
                  >
                    Recent Rooms Scanned
                  </h2>
                </div>
                  ...
                  <div className="space-y-3">
                    {(recentRooms || []).map((room) => (
                      <Card
                        ...
                        className="p-3 w-full bg-green-100 border border-green-300 text-green-800 hover:shadow-md transition-all hover:scale-[1.01]"
                      >
                        ...
                        <p className="text-xs">
                          Last scanned: {formatDateTime(room.created_at)}
                        </p>
                      </Card>
                    ))}
                  </div>
            ...
            {/* My Reports - Redesigned Interactive Section */}
            <section>
              <div className="flex items-center gap-2 mb-4">
              ...
              <Card>
                <CardContent className="pt-4">
                  <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                    <TabsList className="grid w-full grid-cols-3 md:w-[400px]"> {/* Adjusted grid-cols for 3 tabs */}
                      <TabsTrigger value="all">All Reports</TabsTrigger>
                      <TabsTrigger value="pending">Pending</TabsTrigger>
                      <TabsTrigger value="resolved">Resolved</TabsTrigger>
                      {/* Add more tabs as needed, e.g., 'critical' */}
                    </TabsList>
                                  ...
                                  <TableCell className="text-right">
                                    <Dialog>
                                      ...
                                      <DialogContent className="sm:max-w-[425px]">
                                        ...
                                        {selectedReport && ( // Ensure selectedReport exists before rendering
                                          <div className="grid gap-4 py-4">
                                            ...
                                            <div className="grid grid-cols-4 items-center gap-4">
                                              ...
                                              <p className="text-sm col-span-3">{formatDateTime(selectedReport.created_at)}</p>
                                            </div>
                                          </div>
                                        )}
                                        <DialogFooter>
