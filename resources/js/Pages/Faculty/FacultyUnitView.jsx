...
import { Menu, Cpu, HardDrive, Database, MemoryStick, Monitor, SquareCheckBig, ArrowLeft } from "lucide-react";
          ...
          <Card className="w-full max-w-md sm:max-w-lg md:max-w-2xl shadow-lg rounded-2xl border border-gray-200 overflow-hidden">
            ...
            <CardContent className="p-6">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <DetailItem icon={Monitor} label="Unit Code" value={unit.unit_code} />
                <DetailItem icon={Cpu} label="Processor" value={unit.processor} />
                <DetailItem icon={MemoryStick} label="RAM" value={unit.ram} />
                <DetailItem icon={Database} label="Storage" value={unit.storage} />
                <DetailItem icon={HardDrive} label="GPU" value={unit.gpu ?? "N/A"} />
                <DetailItem icon={HardDrive} label="Motherboard" value={unit.motherboard} />
                <DetailItem icon={SquareCheckBig} label="Condition" value={unit.condition} />
              </div>
