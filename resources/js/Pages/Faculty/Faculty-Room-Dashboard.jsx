        ...
        <>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-6 mb-10">
                ...
                className={`rounded-2xl transition-all duration-200 ease-in-out shadow-md 
                    ...
                    ${
                        room.is_active
                        ? "bg-[#59AC77] border border-green-700 text-white"   // 🌿 Active: ISU green
                        : "bg-[#59AC77] border border-yellow-300 text-green-900" // ☀️ Inactive: pastel yellow-gold
                    }`}
                >
                {/* Room Number + Status */}
                <CardHeader className="flex flex-row items-center justify-between pb-2">
                    ...
                    className={`text-lg md:text-xl font-semibold ${
                        room.is_active ? "text-white" : "text-green-900"
                    }`}
                    >
                    {room.room_number}
                    </CardTitle>
                ...
                <CardContent>
                    ...
                    <div className="flex flex-col">
                        ...
                        <span
                        className={`text-xs ${
                            room.is_active ? "text-green-100" : "text-green-700"
                        }`}
                        >
                        {room.scanned_at
